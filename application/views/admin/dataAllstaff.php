<div id="main">
	<div class="full_w">
			...
			<legend><strong>&nbsp;&nbsp;ค้นหาข้อมูลเจ้าหน้าที่&nbsp;&nbsp;&nbsp;</strong></legend>
					<?php echo form_open('admin/dataSearchstaff/'.$this->uri->segment(3)); ?>	
			...
			<fieldset>
   				 <legend><strong>&nbsp;&nbsp;ข้อมูลเกี่ยวกับเจ้าหน้าที่&nbsp;&nbsp;&nbsp;</strong></legend>
		...
		<table>
			...
			<?php
				if($query->num_rows()==0){	
				echo'<tr>';
				echo'<td colspan="4" align="center">'.'ไม่พบข้อมูลเจ้าหน้าที่'.'</td>';
				echo'</tr>';
				}else
				{
				...
				echo '<td>'.anchor('admin/dataOnestaff/'.$this->uri->segment(3).'/'.$row->user_id,'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ดูข้อมูล').'</td>';
