...
<div class="full_w">
<fieldset>
<legend><img src=<?php print base_url()?>assets/img/lika-head.jpg /></legend>
			...
			<?php if ($row->partent_file){
				echo '<div class="sep"></div>	';
				print '<p>'.'<strong> ไฟล์รายละเอียดผลงานลิขสิทธิ์   : </strong>';
				print '<a  href='. base_url('filepartentUpload/'.$row->partent_file) .' class = pdf_icon>'.'ไฟล์รายละเอียดผลงานลิขสิทธิ์  '.'</a>'.'</p>';
